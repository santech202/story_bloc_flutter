...
class SearchTabVideo extends StatefulWidget {
  @override
  _HomePageState createState() => new _HomePageState();
}

class _HomePageState extends State<SearchTabVideo> {
  Timer _timer;
                                                              ...
                                                              snapshot
                                                                  ...
                                                                  : Row(
                                                                      ...
                                                                      children: [
                                                                          Icon(
                                                                              Icons.bookmark,
                                                                              color: Color.fromRGBO(78, 187, 31, 1),
                                                                              size: 22.6),
                                                                          SizedBox(
                                                                            width:
                                                                                5.0,
                                                                          ...
                                                                          Text(
                                                                            AppLocalizations.instance.text('savedposticon'),
                                                                            textAlign:
                                                                                TextAlign.start,
                                                                            style:
                                                                                TextStyle(
